...
def create_shap_explainer(wrapper_fn, background, feature_names):
    # masker = shap.maskers.Partition(background)
    # masker.clustering = Z  # Set partition tree
    explainer = shap.Explainer(wrapper_fn, background, feature_names=feature_names)
    return explainer
...
if __name__ == "__main__":
    ...
    explainer = create_shap_explainer(wrapper_fn, background, feature_names)
